...
function startGame() {
    ...
    musica = new sound('musica/l19.mp3');
    testovita = new component('50px','Consolas','black',42,43,'text');
    ...
    myBackground = new component(2000, 1400, "img/lj.png", 0, 0, "background");
    myGameArea.start();
}
...
if(myGameArea.frameNo>3000){
 ...
 if(myGameArea.frameNo>900 && myGameArea.frameNo<5000){
...
if(myGameArea.frameNo>199999990){
...
if(myGameArea.frameNo>199999999){
...
if(myGameArea.frameNo>9999999999){
    if (myGameArea.frameNo == 1 || everyinterval(300)) {
        num=Math.floor(Math.random()*370)+100;
        x = myGameArea.canvas.width ;
        y = myGameArea.canvas.height - num;
