...
function startGame() {
    ...
    musica = new sound('musica/m4.mp3');
    ...
    myBackground = new component(2000, 1200, "img/l4.gif", 0, 0, "background");
    myGameArea.start();
}
...
function updateGameArea() {
    ...
    if(myGameArea.frameNo<1000){
    if (myGameArea.frameNo == 1 || everyinterval(370)) {
        num=Math.floor(Math.random()*970)+10;
        x = myGameArea.canvas.width ;
        y = myGameArea.canvas.height - num;
    ...
    if (myGameArea.frameNo == 1 || everyinterval(170)) {
        ...
        y = myGameArea.canvas.height - num;
        nemici5.push(new component(120, 160, "img/k1.png", x, y, "image"));
    }
}
   ...
   if(myGameArea.frameNo>4000){
    if (myGameArea.frameNo == 1 || everyinterval(100)) {
        ...
        y = myGameArea.canvas.height - 1100;
        nemici7.push(new component(120, 160, "img/t1.png", x, y, "image"));
    }
   }

   if(myGameArea.frameNo>1000){
    if (myGameArea.frameNo == 1 || everyinterval(500)) {
        num=Math.floor(Math.random()*1270)+1000;
        x = myGameArea.canvas.width ;
        y = myGameArea.canvas.height - num;
        y2 = myGameArea.canvas.height - num+588;
        tubo2.push(new component(130, 600, "img/tubo2.png", x, y, "image"));
        nemici8.push(new component(120, 160, "img/p4.png", x, y2, "image"));
    }
   }

   if(myGameArea.frameNo>4000){
    if (myGameArea.frameNo == 1 || everyinterval(676)) {
...
for (i = 0; i < cannoneb.length; i += 1) {
    ...
    testopunti2.update();
    testopunti3.text="KM fino 6000:"+myGameArea.frameNo;
    testopunti3.update();
    monetap.update();
    myGamePiece.newPos();
    myGamePiece.update();
