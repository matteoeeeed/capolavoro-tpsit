...
function startGame() {
    ...
    musica = new sound('musica/m7.mp3');
    ...
    myBackground = new component(2000, 1000, "img/l5.gif", 0, 0, "background");
    myGameArea.start();
}
...
if(myGameArea.frameNo>999999){
   ...
   if(myGameArea.frameNo>49999999990){
   ...
   if(myGameArea.frameNo>499999999){
