...
function startGame() {
    ...
    musica = new sound('musica/m1d.mp3');
    ...
    myBackground = new component(2000, 1000, "img/dd.webp", 0, 0, "background");
    myGameArea.start();
}
...
if(myGameArea.frameNo>700){
   ...
   if(myGameArea.frameNo>405555500){
    if (myGameArea.frameNo == 1 || everyinterval(200)) {
   ...
   if(myGameArea.frameNo>555555510){
    if (myGameArea.frameNo == 1 || everyinterval(596)) {
        num=Math.floor(Math.random()*1100)+1000;
        x = myGameArea.canvas.width ;
        y = myGameArea.canvas.height - num;
...
if(myGameArea.frameNo>0){
    if (myGameArea.frameNo == 1 || everyinterval(146)) {
        num=Math.floor(Math.random()*970)+10;
        x = myGameArea.canvas.width ;
        y = myGameArea.canvas.height - num;
