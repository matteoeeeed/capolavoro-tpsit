...
function startGame() {
    ...
    musica = new sound('musica/m11.mp3');
    ...
    myBackground = new component(2000, 1000, "img/clound.gif", 0, 0, "background");
    myGameArea.start();
}
...
if(myGameArea.frameNo>8600){
    window.location.assign("boss2.html");
}
