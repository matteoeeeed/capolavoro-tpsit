...
function startGame() {
    ...
    boss= new component(500,500,"img/kp1.png",1535,323,"image");
    ...
    myBackground = new component(2000, 1200, "img/d3d.png", 0, 0, "background");
    myGameArea.start();
}
...
if(myGameArea.frameNo>8000){
 ...
 if(myGameArea.movebossx>200){
     ...
     if(num==1){
        boss.image.src="img/kp3.png";
    }
    if(num==2){
        boss.image.src="img/kp4.png";
    }
    if(num==3){
        boss.image.src="img/kp5.png";
    }
    ...
    if(num==1){
       boss.image.src="img/kp1.png";
   }
   if(num==2){
       boss.image.src="img/kp2.png";
   }
