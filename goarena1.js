...
function startGame() {
    ...
    myBackground = new component(2000, 1000, "img/l1.gif", 0, 0, "background");
    myGameArea.start();
}
...
if(myGameArea.frameNo>9999999999999999999500){
...
for (i = 0; i < cannoneb.length; i += 1) {
    ...
    testopunti2.update();
    testopunti3.text="KM:"+myGameArea.frameNo;
    testopunti3.update();
    monetap.update();
    myGamePiece.newPos();
    myGamePiece.update();
