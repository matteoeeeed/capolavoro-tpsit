...
function startGame() {
    ...
    musica = new sound('musica/ma.mp3');
    testovita = new component('50px','Consolas','red',42,43,'text');
    testopunti = new component('50px','Consolas','black',1200,43,'text');
    testopunti2 = new component('50px','Consolas','balck',620,43,'text');
    testopunti3 = new component('50px','Consolas','black',20,943,'text');
    myBackground = new component(2000, 1000, "img/water.gif", 0, 0, "background");
    myGameArea.start();
}
...
function updateGameArea() {
    ...
    if (myGameArea.frameNo == 1 || everyinterval(70)) {
        ...
        nemici1.push(new component(90, 81, "img/fishh1.png", x, y, "image"));
        }
    }
    ...
    if (myGameArea.frameNo == 1 || everyinterval(70)) {
        ...
        y = myGameArea.canvas.height - num;
        nemici2.push(new component(90, 81, "img/fishh3.png", x, y, "image"));
    }
    }

    if(myGameArea.frameNo>9990){
...
if(myGameArea.frameNo>99999500){
...
for (i = 0; i < nemici1.length; i += 1) {
       ...
       nemici1[i].update();
        ...
        if (n == 1) {
            nemici1[i].image.src = "img/fishh1.png";
        } 
        if (n == 2) {
            nemici1[i].image.src = "img/fishh2.png";
        } 
...
for (i = 0; i < nemici2.length; i += 1) {
        ...
        let n = Math.floor(Math.random() * 2) + 1;
        if (n == 1) {
            nemici2[i].image.src = "img/fishh3.png";
        } 
        if (n == 2) {
            nemici2[i].image.src = "img/fishh4.png";
        } 
