...
function startGame() {
    ...
    myBackground = new component(2000, 1000, "img/l11.jpg", 0, 0, "background");
    myGameArea.start();
}
...
if(myGameArea.frameNo>700){
    if (myGameArea.frameNo == 1 || everyinterval(320)) {
        num=Math.floor(Math.random()*1100)+950;
        numd=Math.floor(Math.random()*13)+3;
        x = myGameArea.canvas.width ;
        x2 = myGameArea.canvas.width+38 ;
        y = myGameArea.canvas.height - num;
...
if(myGameArea.frameNo>9999999990){
...
if(myGameArea.frameNo>99999999930){
...
if(myGameArea.frameNo>8600){
    ...
    testopunti2.update();
    testopunti3.text="KM fino 8600:"+myGameArea.frameNo;
    testopunti3.update();
    monetap.update();
    myGamePiece.newPos();
    myGamePiece.update();
