...
function startGame() {
    ...
    musica = new sound('musica/m16.mp3');
    ...
    myBackground = new component(2000, 1000, "img/w5.jpg", 0, 0, "background");
    myGameArea.start();
}
