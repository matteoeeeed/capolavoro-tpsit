...
function startGame() {
    ...
    musica = new sound('musica/fi.mp3');
    ...
    myBackground = new component(2000, 1200, "img/f.png", 0, 0, "background");
    myGameArea.start();
}
...
if(myGameArea.frameNo>900){
    ...
    if (myGameArea.frameNo == 1 || everyinterval(199999999950)) {
...
if(myGameArea.frameNo>90999999990){
...
if(myGameArea.frameNo>99999){
    if (myGameArea.frameNo == 1 || everyinterval(106)) {
        num=Math.floor(Math.random()*970)+10;
        x = myGameArea.canvas.width ;
        y = myGameArea.canvas.height - num;
...
if(myGameArea.frameNo>9000){
    ...
    testopunti2.update();
    testopunti3.text="ondata fino a 100000:"+myGameArea.frameNo;
    testopunti3.update();
    monetap.update();
    myGamePiece.newPos();
    myGamePiece.update();
