...
function startGame() {
    ...
    musica = new sound('musica/m20.mp3');
    ...
    myBackground = new component(2700, 1400, "img/ljj.png", 0, 0, "background");
    myGameArea.start();
}
...
if(myGameArea.frameNo>10000){
    window.location.assign("javabossfinal.html");
}
