...
function startGame() {
    ...
    musica = new sound('musica/m13.mp3');
    ...
    myBackground = new component(2000, 1000, "img/w3.gif", 0, 0, "background");
    myGameArea.start();
}
...
if(myGameArea.frameNo>0){
    ...
    if(myGameArea.frameNo>70777770){
    if (myGameArea.frameNo == 1 || everyinterval(320)) {
...
if(myGameArea.frameNo>7777777700){
    if (myGameArea.frameNo == 1 || everyinterval(320)) {
...
if(myGameArea.frameNo>10999999999990){
...
if(myGameArea.frameNo>10999999999900){
    if (myGameArea.frameNo == 1 || everyinterval(280)) {
...
if(myGameArea.frameNo>300999999990){
   ...
   if(myGameArea.frameNo>30999999999900){
   ...
   if(myGameArea.frameNo>49999999900){
...
if(myGameArea.frameNo>400){
    if (myGameArea.frameNo == 1 || everyinterval(430)) {
...
if(myGameArea.frameNo>0){
    if (myGameArea.frameNo == 1 || everyinterval(126)) {
        num=Math.floor(Math.random()*970)+10;
        x = myGameArea.canvas.width ;
        y = myGameArea.canvas.height - num;
...
if(myGameArea.frameNo>0){
    if (myGameArea.frameNo == 1 || everyinterval(30)) {
        num=Math.floor(Math.random()*1270)+10;
        x = myGameArea.canvas.width ;
        y = myGameArea.canvas.height - num;
        nemici29.push(new component(80, 80, "img/fish.png", x, y, "image"));
    }
}
...
if(myGameArea.frameNo>10){
    if (myGameArea.frameNo == 1 || everyinterval(30)) {
        ...
        x = myGameArea.canvas.width ;
        y = myGameArea.canvas.height - num;
        nemici30.push(new component(80, 80, "img/fish2.png", x, y, "image"));
    }
}
...
if(myGameArea.frameNo>10){
    if (myGameArea.frameNo == 1 || everyinterval(100)) {
        ...
        x = myGameArea.canvas.width ;
        y = myGameArea.canvas.height - num;
        nemici31.push(new component(80, 80, "img/fir.png", x, y, "image"));
        nemici12b.push(new component(50, 50, "img/fire.png", x, y, "image"));
    }
}
...
for (i = 0; i < nemici30.length; i += 1) {
    let numx = Math.floor(Math.random() * 50) - 30;
    nemici30[i].x += -21; 
    nemici30[i].y += -numx; 
    nemici30[i].width +=1;
    nemici30[i].height +=1;
...
for (let i = 0; i < nemici31.length; i += 1) {
    ...
    nemici31[i].update();
    let n = Math.floor(Math.random() * 2) + 1;
    if(nemici31[i].x<1500){
        speed = speed+35;
        nemici31[i].x += speed * Math.cos(angle);
        nemici31[i].y += speed * Math.sin(angle);
        if (n == 1) {
            nemici31[i].image.src = "img/fir.png";
        } else if (n == 2) {
            nemici31[i].image.src = "img/fir2.png";
        }
    }else{
        if (n == 1) {
            nemici31[i].image.src = "img/fir2.png";
...
for (i = 0; i < nemici12b.length; i += 1) {
    var deltaX = myGamePiece.x - nemici12b[i].x;
    var deltaY = myGamePiece.y - nemici12b[i].y;
    var angle = Math.atan2(deltaY, deltaX);
    var speed = 15;
    nemici12b[i].x += speed * Math.cos(angle);
    nemici12b[i].y += speed * Math.sin(angle);
    if(nemici12b[i].x<1500){
    nemici12b[i].x-=41;
    nemici12b[i].y-=1;
    speed = 0;
    }
    ...
    let n = Math.floor(Math.random() * 2) + 1;
    if (n == 1) {
        nemici12b[i].image.src = "img/fire.png";
    } 
    if (n == 2) {
        nemici12b[i].image.src = "img/fire2.png";
    } 
    if (n == 2) {
        nemici12b[i].image.src = "img/fire3.png";
    } 
    if (myGamePiece.crashWith(nemici12b[i])) {
        let n2 = Math.floor(Math.random() * 2) + 1;
        if (myGameArea.keys && myGameArea.keys[32]) {    
            myGameArea.vitaMario -= 9;
            if(n2==1){
